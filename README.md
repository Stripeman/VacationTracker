...
![Version](https://img.shields.io/badge/version-0.9.2--beta-38bdf8) ![Status](https://img.shields.io/badge/status-active-34d399)
...
- **Active / Inactive** — an admin can mark a user **Inactive** (keeps the record and role but revokes access until reactivated), shown as a coloured badge, and filter the list by **All / Active / Inactive**.
